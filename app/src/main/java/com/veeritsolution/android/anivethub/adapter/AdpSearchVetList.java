...
public class AdpSearchVetList extends BaseAdapter {
    ...
    public AdpSearchVetList(Context context, List<SearchVetModel> vetList, View.OnClickListener onClickListener) {
