...
public class VetNotiFragment extends Fragment implements OnClickEvent, OnBackPressedEvent, DataObserver {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.fragment_vet_notifications, container, false);
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_submit_rejection:
                ...
                if (object != null) {
                    ...
                    vetVideoCallReject(appointmentRejectModel);
                }
                break;
    ...
    private void getNotificationInfo(int pageNo, boolean isDialogRequired) {
        ...
        try {
            ...
            params.put("op", ApiList.GET_VET_NOTIFICATIONS);
            ...
            RestClient.getInstance().post(getActivity(), Request.Method.POST, params, ApiList.GET_VET_NOTIFICATIONS,
    ...
    private void readyForVideoCall() {
        try {
            params = new JSONObject();
            params.put("op", ApiList.VET_APPOINTMENT_CONFIRM);
            params.put("AuthKey", ApiList.AUTH_KEY);
            params.put("VetAppointmentId", notificationModel.getVetAppointmentId());

            RestClient.getInstance().post(getActivity(), Request.Method.POST, params, ApiList.VET_APPOINTMENT_CONFIRM,
                    true, RequestCode.VetAppointmentConform, this);
    ...
    private void vetVideoCallReject(AppointmentRejectModel appointmentRejectModel) {

        try {
            params = new JSONObject();
            params.put("op", ApiList.VET_APPOINTMENT_CANCEL);
            params.put("AuthKey", ApiList.AUTH_KEY);
            params.put("VetAppointmentId", notificationModel.getVetAppointmentId());
            ...
            RestClient.getInstance().post(getActivity(), Request.Method.POST, params, ApiList.VET_APPOINTMENT_CANCEL,
                    true, RequestCode.VetAppointmentCancel, this);
