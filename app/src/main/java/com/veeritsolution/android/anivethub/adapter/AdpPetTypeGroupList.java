...
public class AdpPetTypeGroupList extends BaseAdapter {

    private Context context;
    private List<?> list;

    public AdpPetTypeGroupList(Context context, List<?> list) {
...
//        holder.linearLayout.setTag(obj);
        ...
        if (obj instanceof PetTypeGroupModel) {
            //holder.tvPetTypeAndBreed.setText(list.get(i));
            PetTypeGroupModel petTypeGroupModel = (PetTypeGroupModel) obj;
            holder.tvPetTypeAndBreed.setText(petTypeGroupModel.getPetTypeGroupName());
