    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
           ...
           // holder.footerView.setVisibility(View.GONE);
            ...
            if (position == 0) {
                holder.linLocation.setBackgroundColor(ResourcesCompat.getColor(context.getResources(), R.color.colourListBack, null));
            } else if ((position % 2) == 0) {
                holder.linLocation.setBackgroundColor(ResourcesCompat.getColor(context.getResources(), R.color.colourListBack, null));
            } else {
                holder.linLocation.setBackgroundColor(ResourcesCompat.getColor(context.getResources(), R.color.white, null));
            }
       ...
       // View footerView;
        ...
        ViewHolder(View convertView) {
          ...
          //  footerView = convertView.findViewById(R.id.footerview);
            ...
            //  Set Font Type
            txtLocationName.setTypeface(MyApplication.getInstance().FONT_ROBOTO_REGULAR);
