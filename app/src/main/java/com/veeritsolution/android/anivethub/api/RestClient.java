...
public class RestClient {
    ...
    public void post(Context mContext, int mRequestMethod, /*final Map<String, String> mapParams,*/
                     JSONObject mPostParams, String url, boolean isDialogRequired, final RequestCode mRequestCode, final DataObserver dataObserver) {
        ...
        try {
            if (Utils.isInternetAvailable()) {
                ...
                JsonRequest mPostRequest = new JsonRequest(mRequestMethod, postUrl, mPostParams.toString(), new Response.Listener<JSONArray>() {
                    @Override
